...
extern U32 volatile CoIdleCtrl;		    // Counter for Idle Task
extern U32 volatile CoIdleCtrMax;		// Max Counter for Idle Task
extern U8 volatile CoStatRdy;			// Enable Stat task.
extern S8 volatile CoCPUUsage;          // % CpuUsage
extern S8 volatile CoCPUUsagePeak;      // % Peack Cpu Usage  
extern U32 volatile CoIdleCtrRun;		// val. reached by idle ctr at run time in 1 sec
OS_STK   stat_stk[CFG_STAT_STACK_SIZE];
#endif
