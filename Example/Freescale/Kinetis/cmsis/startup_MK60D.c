...
void WEAK DMA4_IRQHandler(void);
void WEAK DMA5_IRQHandler(void);
void WEAK DMA6_IRQHandler(void);
void WEAK DMA7_IRQHandler(void);
void WEAK DMA8_IRQHandler(void);
void WEAK DMA9_IRQHandler(void);
void WEAK DMA10_IRQHandler(void);
void WEAK DMA11_IRQHandler(void);
void WEAK DMA12_IRQHandler(void);
void WEAK DMA13_IRQHandler(void);
void WEAK DMA14_IRQHandler(void);
void WEAK DMA15_IRQHandler(void);
void WEAK DMA_Error_IRQHandler(void);
void WEAK MCM_IRQHandler(void);
void WEAK FTFL_IRQHandler(void);
...
void WEAK Reserved51_IRQHandler(void);
void WEAK Reserved52_IRQHandler(void);
...
void WEAK Reserved60_IRQHandler(void);
...
void WEAK Reserved83_IRQHandler(void);
...
void (* const g_pfnVectors[0x100])(void) = {
    ...
    /*----------External Exceptions-------------------------------------------*/
    DMA0_IRQHandler,              /*!< DMA channel 0/16 transfer complete interrupt */
    DMA1_IRQHandler,              /*!< DMA channel 1/17 transfer complete interrupt */
    DMA2_IRQHandler,              /*!< DMA channel 2/18 transfer complete interrupt */
    DMA3_IRQHandler,              /*!< DMA channel 3/19 transfer complete interrupt */
    DMA4_IRQHandler,              /*!< DMA channel 4/20 transfer complete interrupt */
    DMA5_IRQHandler,              /*!< DMA channel 5/21 transfer complete interrupt */
    DMA6_IRQHandler,              /*!< DMA channel 6/22 transfer complete interrupt */
    DMA7_IRQHandler,              /*!< DMA channel 7/23 transfer complete interrupt */
    DMA8_IRQHandler,              /*!< DMA channel 8/24 transfer complete interrupt */
    DMA9_IRQHandler,              /*!< DMA channel 9/25 transfer complete interrupt */
    DMA10_IRQHandler,             /*!< DMA channel 10/26 transfer complete interrupt */
    DMA11_IRQHandler,             /*!< DMA channel 11/27 transfer complete interrupt */
    DMA12_IRQHandler,             /*!< DMA channel 12/28 transfer complete interrupt */
    DMA13_IRQHandler,             /*!< DMA channel 13/29 transfer complete interrupt */
    DMA14_IRQHandler,             /*!< DMA channel 14/30 transfer complete interrupt */
    DMA15_IRQHandler,             /*!< DMA channel 15/31 transfer complete interrupt */
    DMA_Error_IRQHandler,               /*!< DMA error interrupt */
    MCM_IRQHandler,                     /*!< Normal interrupt */
    FTFL_IRQHandler,                    /*!< FTFE interrupt */
    ...
    Reserved51_IRQHandler,                 /*!< I2S0 transmit interrupt */
    Reserved52_IRQHandler,                 /*!< I2S0 receive interrupt */
    ...
    Reserved60_IRQHandler,               /*!< Reserved interrupt 60 */
...
#pragma weak FTFL_IRQHandler = Default_Handler
